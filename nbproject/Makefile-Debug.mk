...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mylastipdaemon
...
${OBJECTDIR}/_http-post.o: _http-post.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_http-post.o _http-post.c

${OBJECTDIR}/_old_sockimpl.o: _old_sockimpl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_old_sockimpl.o _old_sockimpl.c
...
${OBJECTDIR}/mylastipd.o: mylastipd.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mylastipdaemon
